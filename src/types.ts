...
export interface GeneratedRelease {
  ...
  isFallback?: boolean;   // Indicates if report was generated by the local rule-based safety fallback engine
  fallbackReason?: string;// Reason for local engine fallback ("no_api_key" | "quota_exhausted" | "invalid_api_key" | "api_error")
  errorDetails?: string;  // Detailed error message from the API or server
}
